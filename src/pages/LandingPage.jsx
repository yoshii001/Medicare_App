...
import { getDoctors, getPatients, getClinics } from '../services/database';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
              Modern Healthcare <span className="text-primary-600 block">Management</span>
            </h1>
              ...
              <div className="bg-primary-50 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded-lg p-3 flex items-center justify-between">
                    ...
                    <span className="font-semibold text-primary-600">{dashboardStats.patients}</span>
                  </div>
                  <div className="bg-white rounded-lg p-3 flex items-center justify-between">
                    <span className="text-sm text-gray-600">Total Doctors</span>
                    <span className="font-semibold text-success-600">{dashboardStats.doctors}</span>
                  </div>
                  <div className="bg-white rounded-lg p-3 flex items-center justify-between">
                    <span className="text-sm text-gray-600">Total Clinics</span>
                    <span className="font-semibold text-warning-600">{dashboardStats.clinics}</span>
                  </div>
                </div>
              </div>
      ...
      {/* features, about, testimonials, contact, footer */}
      {/* (Not rewritten here for brevity, since your error was only in the stats section) */}
